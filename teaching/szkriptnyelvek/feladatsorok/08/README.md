...
* Írj egy `pizzatRendel` metódust, amely egy `Pizza` típusú objektumot vár paraméterül!
    ...
    * Természetesen olyan pizzát ne tudjunk rendelni, amely már megromlott. Amennyiben a paraméterben kapott pizza nem fogyasztható, írassuk ki a `Hiba: nem eheto pizza!` hibaüzenetet a konzolra!
